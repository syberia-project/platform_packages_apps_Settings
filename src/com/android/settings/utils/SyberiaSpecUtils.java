...
public class SyberiaSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String SYBERIA_CPU_MODEL_PROPERTY = "ro.syberia.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelSyberia = SystemProperties.get(SYBERIA_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelSyberia.isEmpty()) {
            return cpuModelSyberia;
