...
public class FpWakeUnlockSelectorController extends BasePreferenceController
    ...
    private int getCurrentMode() {
        ...
        int fpWakeUnlock = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.FINGERPRINT_WAKE_UNLOCK, 0, UserHandle.USER_CURRENT);
        switch (fpWakeUnlock) {
            case 0:
    ...
    public final boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Settings.System.putInt(mContext.getContentResolver(), Settings.System.FINGERPRINT_WAKE_UNLOCK , newMode);
