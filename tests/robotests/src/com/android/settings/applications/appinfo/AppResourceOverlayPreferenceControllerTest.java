...
public class AppResourceOverlayPreferenceControllerTest {
    ...
    private AppResourceOverlayPreferenceController mController;
    ...
    public void setUp() {
        ...
        mController = new AppResourceOverlayPreferenceController(mContext);
        mController.setParent(mFragment);
        mController.setState(mState);
    ...
    public void getAvailabilityStatus_isAlwaysAvailable() {
        assertThat(mController.getAvailabilityStatus())
            .isEqualTo(AppResourceOverlayPreferenceController.AVAILABLE);
    }
